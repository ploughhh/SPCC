...
from scvi.nn import MultiDecoder, one_hot
from ._components import MultiEncoder, Encoder
...
class JVAE(BaseModuleClass):
    ...
    def __init__(
        ...
        elif self.dispersion == "gene-cell":  # gene-cell
            pass

    def sample_from_posterior_z(
        # self, x: torch.Tensor, spatial_metric: torch.Tensor, mode: int = None, deterministic: bool = False
        ...
        # outputs = self.inference(x, spatial_metric, mode)
    ...
    def _get_inference_input(self, tensors):
        # return dict(x=tensors[REGISTRY_KEYS.X_KEY], spatial_metric=tensors[REGISTRY_KEYS.SPATIAL_METRIC])
    ...
    def inference(self, x: torch.Tensor, mode: Optional[int] = None) -> dict:
        ...
        # qz_m, qz_v, z = self.z_encoder(x_, spatial_metric, mode)
